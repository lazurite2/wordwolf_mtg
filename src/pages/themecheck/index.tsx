    ...
    <>
      ...
      <div className="flex flex-col items-center">
        <div className="flex gap-2 items-center">
          ...
          <span className="font-mplus text-2xl font-bold pb-10">さんが</span>
        </div>
        <span className="font-mplus text-2xl" >この画面を見てください </span>
        <span className="font-mplus text-2xl">準備はいいですか？</span>
        <div className="pt-10">
          <button className="border-2 p-2 bg-blue-300 rounded-md border-blue-300">
            お題を表示
          </button>
        </div>
      </div>
